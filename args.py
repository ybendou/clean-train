...
parser.add_argument("--sample-outer-bb", action="store_true", help="Sample outer bounding box")

parser.add_argument("--seed", type=int, default=-1, help="set random seed manually, and also use deterministic approach")
parser.add_argument("--wandb", type=str, default="", help="Report to wandb, entity name")
