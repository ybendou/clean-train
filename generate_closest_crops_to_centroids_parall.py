...
args = process_arguments(params={'dataset':'miniimagenet', 'n_runs':10000, 'n_shots':1, 'preprocessing':'ME','n_ways':5,
                                ...
                                'load_model':'/users/local/y17bendo/backbones/miniStandard1.pt', 'batch_size':256, 'dropout':False, 'augmentations':True, 'n_augmentation': 200})
fix_seed(args.seed)
...
torch.save(closest_crops, f'/users/local/y17bendo/data/AugmentedSamples/features/miniImagenet/changing_input_size/standardTrainingFeatures/closest_crops_standard_training_batch_size{args.batch_size}.pt')
